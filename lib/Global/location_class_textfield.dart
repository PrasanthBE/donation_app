...
//
// class DynamicLocationForms extends StatefulWidget {
...
//
//   @override
//   _DynamicLocationFormsState createState() => _DynamicLocationFormsState();
// }
//
// class _DynamicLocationFormsState extends State<DynamicLocationForms> {
...
//
//       // Add location data string for field_value
...
//       }
//     } catch (e) {
//       // _showToast("Failed to fetch address: ${e.toString()}");
//       _showToast("Failed to fetch address");
//       setState(() {
//         fieldLocationModes[fieldName] = 0;
//         fieldFetchingStates[fieldName] = false;
...
//   //   // Simplified district loading - you can implement your API call here
//   //   setState(() {
//   //     stateDistricts[fieldName] = [
//   //       'District 1',
//   //       'District 2',
...
//                         child:
//                             isOnline
//                                 ? _buildDistrictDropdown(fieldName, isMandatory)
//                                 : _buildTextField(
